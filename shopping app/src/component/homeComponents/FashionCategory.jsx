...
import womensfashion from "../../assets/images/womensfashion.jpg";
...
const FashionCategory = () => {
  ...
  const ref = useRef(null);
    ...
    const Images = [
      { name: "MENS WEAR", image: mensfashion },
      { name: "WOMENS WEAR", image: womensfashion },
      { name: "KIDS WEAR", image: kidsfashion },
      { name: "SHOES", image: sneakers },
    ];
